...
\KwIn{\emph{setpoint}, \emph{actual\_position}}
\KwOut{\emph{control\_signal}}
...
\uIf{$|error| > error\_threshold$}{
  $(K_p, K_i, K_d) \gets (K_p^{\text{high}}, K_i^{\text{high}}, K_d^{\text{high}})$\;
}
\Else{
  $(K_p, K_i, K_d) \gets (K_p^{\text{low}}, K_i^{\text{low}}, K_d^{\text{low}})$\;
}
